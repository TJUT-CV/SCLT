...
class EnvSettings:
    def __init__(self):
        ...
        sclt_vot_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../..'))
        ...
        self.otb_path = r'/home/ubuntu/data/OTB100'.format(pytracking_path)
        self.tlp_path = r'/home/ubuntu/data/TLP/TLP'
        self.vot2018_lt_path = r'/home/ubuntu/data/vot2018_lt'
        self.vot2019_lt_path = r'/home/ubuntu/data/VOT2019LT'
        self.nfs_path = r'/home/ubuntu/data/Nfs/Nfs'
        self.uav_path = r'/home/ubuntu/data/uav123'
        self.tpl_path = ''
        self.vot_path = r'/home/ubuntu/data/vot2018'
        self.got10k_path = r'/home/ubuntu/data/got10k'
        self.lasot_path = '/home/ubuntu/data/LaSOT/LaSOTBenchmark'
        self.lasot_extension_subset_path = ''
        self.trackingnet_path = ''
        self.oxuva_path = '/home/ubuntu/data/Oxuva'
        self.davis_dir = ''
        self.youtubevos_dir = ''
        ...
        self.sclt_path = pytracking_path
        self.sclt_vot_path = sclt_vot_path
