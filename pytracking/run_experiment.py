...
def run_experiment(experiment_module: str, experiment_name: str, debug=0, threads=0,gpu_id=None):
    """Run experiment.
    args:
...
def main():
    ...
    run_experiment(args.experiment_module, args.experiment_name, args.debug, args.threads,args.gpu_id)
